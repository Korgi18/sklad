...
<head>
    ...
    <script type="text/javascript">
        ...
        <div><img src="https://mc.yandex.ru/watch/73529005" style="position:absolute; left:-9999px;" alt="" /></div>
...
<body>
    ...
    <form action="index.php" method="GET">
        <div class="button_search">
            <input name='search' placeholder="Поиск" value="<?= isset($_GET['search']) ? $_GET['search'] : '' ?>" type="search">
